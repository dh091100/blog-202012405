package idusw.springboot.ldhblog.aop;
...
class LogAspect { // @AspectJ 지원 AOP, 횡단 관심 - 공통 기능 (로그, .... ),
    ...
    @Pointcut("execution(* idusw.springboot.ldhblog.serivce.MemberServiceImpl.*(..))")
    ...
    @AfterReturning("execution(* idusw.springboot.ldhblog.serivce.MemberServiceImpl.*(..))")
